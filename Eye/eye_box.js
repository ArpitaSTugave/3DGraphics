...
//find points for the box////
	
	box_y = (((big_ix-20 - big_ix)/(big_fx - big_ix))*(big_fy- big_iy)) + big_iy;
	box_diff = -(box_y - big_iy);
	box_y = big_iy+ box_diff;

	box_x1 = (((big_iy-20 - big_iy)/(big_fy - big_iy))*(big_fx- big_ix)) + big_ix;
	box_diff = (box_x1 - big_ix);
	box_x1 = big_ix+ box_diff;

	box_x2 = (((big_iy+20 - big_iy)/(big_fy - big_iy))*(big_fx- big_ix)) + big_ix;
	box_diff = (box_x2 - big_ix);
	box_x2 = big_ix+ box_diff;
	
	box_angle = (Math.atan((big_iy - big_fy)/(big_ix - big_fx))*180)/pi; 
	...
	context.lineTo(big_ix+20,box_y);
	context.stroke();
	}
	}
	...
	context.beginPath();
	context.moveTo(big_ix,big_iy);
	context.lineTo(box_x1,big_iy-20);
	context.stroke();
	}
	}
	...
	context.beginPath();
	context.moveTo(big_ix,big_iy);
	context.lineTo(box_x2,big_iy+20);
	context.stroke();
	}
	}
...
//box
	...
	context.strokeStyle = "rgb(200,200,200)";
  	context.rect(big_ix-20,big_iy-20,40,40);
	context.stroke();
